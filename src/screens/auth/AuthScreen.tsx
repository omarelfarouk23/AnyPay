...
// PERFORMANCE: StyleSheet is defined outside the component to prevent
// recreation on every render. Styles are static and don't depend on props.
...
export const AuthScreen: React.FC<AuthScreenProps> = ({onLoginSuccess}) => {
  // Note: Auth state is managed by the navigation stack.
  // This screen is only rendered when not authenticated.
  React.useEffect(() => {
    // Navigation handles auth state — this component just displays the landing UI.
  }, []);
...
// PERFORMANCE: StyleSheet.create is called once at module load time,
// not on every render. This avoids unnecessary object allocation.
